...
--#
--#
--#  Write a solution to find the average selling price for each product. average_
--# price should be rounded to 2 decimal places. If a product does not have any
...
--#
--#
--#  Related Topics Database 👍 1773 👎 251
--
--
...
LEFT JOIN
    UnitsSold us
ON
    us.product_id = p.product_id AND us.purchase_date BETWEEN p.start_date AND p.end_date
GROUP BY
    1